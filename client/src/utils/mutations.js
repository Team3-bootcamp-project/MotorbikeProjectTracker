...
mutation updateProject($projectId: ID!, $estimatedCost: Float, $projectName: String) {
  updateProject(projectId: $projectId, estimatedCost: $estimatedCost, projectName: $projectName) {
    _id
    projectName
    estimatedCost
